 ...
 * @param {string} contextName - Name of what's being validated (e.g., 'User', 'Report')
...
export const createValidator = (schema, contextName) => {
   ...
   * @param {string} options.actionName - The specific action/event (e.g., 'login', 'createReport')
...
export const schemas = {
  ...
  reportTitle: z.string().min(3, "Title must be at least 3 characters").max(100, "Title cannot exceed 100 characters"),
  projectName: z.string().min(3, "Project name must be at least 3 characters").max(100, "Project name cannot exceed 100 characters"),
  ...
  requiredFormField: z.string().min(1, "This field is required"),
};